...
const BuyerInformation: FC = () => {
  ...
  const setHasBuyerInformationData = useContractStore((state) => state.setHasBuyerInformationData);
  const { isPending: personsByTypeQueryPending, data: personsByTypeQueryData, refetch: getPersonsByTypeQuery } = useGetPersonsByTypeQuery({ ContractBusinessId: contractBusinessId, Type: "Buyer" });
  ...
  useEffect(() => {
    if (personsByTypeQueryData) {
      ...
      if (personsByTypeQueryData) {
        setHasBuyerInformationData(personsByTypeQueryData.data && personsByTypeQueryData.data.length > 0);
      }
    }
      ...
      <div className="flex items-center justify-center py-10 px-5 w-full">
        <div className="grid grid-cols-12 items-center space-y-4 md:space-y-0 md:gap-10 w-full md:w-[80%]">
          <div className="flex flex-col items-start col-span-12 md:col-span-6 lg:col-span-4">
            {/* <p className="text-gray-800 text-center text-sm text-nowrap">نام :</p> */}
          ...
          <div className="flex flex-col items-start col-span-12 md:col-span-6 lg:col-span-4">
            {/* <p className="text-gray-800 text-center text-sm text-nowrap"> نام خانوادگی :</p> */}
          ...
          <div className="flex flex-col items-start col-span-12 md:col-span-6 lg:col-span-4">
            {/* <p className="text-gray-800 text-center text-sm text-nowrap">نام پدر :</p> */}
          ...
          <div className="flex flex-col items-start col-span-12 md:col-span-6 lg:col-span-4">
            {/* <p className="text-gray-800 text-center text-sm text-nowrap">کد ملی :</p> */}
          ...
          <Button disabled={addPersonPending} onClick={handleSubmit(onSubmit)} className="self-start col-span-12 md:col-span-6 lg:col-span-2">
            {addPersonPending || updatePersonPending ? "در حال ثبت" : " ثبت خریدار"}
          </Button>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-10 w-full ">
        {personsByTypeQueryPending ? "لطفا صبر کنید..." : <DataTable data={tableData ? tableData : []} columns={columns} />}
      </div>
    </>
  );
};
